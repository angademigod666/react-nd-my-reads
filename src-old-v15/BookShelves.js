            ...
            <div className="list-books-content">
              	<div>
                	<Shelf order={currentlyReadingOrder} books={books.filter(currentBook=>currentBook.shelf==='currentlyReading')} 
							move={this.moveBook}/>
                	<Shelf order={wantToReadOrder} books={books.filter(currentBook=>currentBook.shelf==='wantToRead')} move={this.moveBook} />
      				<Shelf order={readOrder} books={books.filter(currentBook=>currentBook.shelf==='read')} move={this.moveBook} />
            	</div>
            </div>    
